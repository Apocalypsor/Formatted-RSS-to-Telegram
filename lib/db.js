...
async function getHistory(uniqueHash, url, telegramName, telegramChatId) {
    const db = await get();
    const result = db.exec(`
        ...
        WHERE url = '${url}'
          ...
          AND telegram_name = '${telegramName}'
...
module.exports = {
    init, getHistory, addHistory, updateHistory, write, get, updateExpire,
}
